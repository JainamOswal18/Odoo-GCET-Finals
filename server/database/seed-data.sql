...
-- Sample Contacts (with ALL fields)
INSERT INTO contacts (name, contact_type, email, phone, address, city, state, country, postal_code, tax_id, is_vendor, is_customer, credit_limit, payment_terms, contact_person, notes, active, created_by) VALUES
('ABC Suppliers Ltd', 'vendor', 'contact@abcsuppliers.com', '+91-9876543210', '123 Industrial Area, Phase 2', 'Ahmedabad', 'Gujarat', 'India', '380001', 'GSTIN24ABCDE1234F1Z5', 1, 0, NULL, 30, 'Mr. Rajesh Kumar', 'Reliable furniture supplier with 10+ years experience', 1, 1),
('XYZ Traders', 'vendor', 'info@xyztraders.com', '+91-9876543211', '456 Market Street, Sector 5', 'Ahmedabad', 'Gujarat', 'India', '380002', 'GSTIN24XYZTR5678G2A6', 1, 0, NULL, 45, 'Ms. Priya Sharma', 'Electronics and IT equipment supplier', 1, 1),
('Global Enterprises', 'customer', 'sales@globalent.com', '+91-9876543212', '789 Business Park, Tower A', 'Ahmedabad', 'Gujarat', 'India', '380003', 'GSTIN24GLOBE9012H3B7', 0, 1, 500000.00, 30, 'Mr. Amit Patel', 'Large corporate client, orders bulk furniture', 1, 1),
('Premium Buyers Co', 'customer', 'purchase@premiumbuyers.com', '+91-9876543213', '321 Tech Hub, Building 3', 'Ahmedabad', 'Gujarat', 'India', '380004', 'GSTIN24PREMI3456I4C8', 0, 1, 300000.00, 15, 'Ms. Neha Desai', 'Premium segment client with quick payment cycles', 1, 1),
('Multi Trade Corp', 'both', 'admin@multitrade.com', '+91-9876543214', '654 Commerce Center, Wing B', 'Ahmedabad', 'Gujarat', 'India', '380005', 'GSTIN24MULTI7890J5D9', 1, 1, 750000.00, 30, 'Mr. Vijay Singh', 'Both supplier and customer, strong business relationship', 1, 1);
