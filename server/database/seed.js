...
async function seed() {
    try {
       ...
       ('INV-2026-003', 5, 3, '2026-01-26', '2026-02-25', 'posted', 'unpaid', 50000.00, 9000.00, 59000.00, 0.00, 59000.00, 'Mixed order invoice', 1, '2026-01-26 14:20:00', 1),
       ('INV-2026-004', 10, NULL, '2026-01-27', '2026-03-13', 'posted', 'unpaid', 35000.00, 6300.00, 41300.00, 0.00, 41300.00, 'Direct invoice - 45 days payment terms', 1, '2026-01-27 11:15:00', 1),
       ('INV-2026-005', 8, NULL, '2026-01-29', '2026-02-28', 'draft', 'unpaid', 25000.00, 4500.00, 29500.00, 0.00, 29500.00, 'Pending approval', 0, NULL, 1)`
        );
       ...
       (3, 3, 'LED monitors', 3, 12000.00, 18.00, 36000.00, 2),
       (3, 4, 'Wireless keyboards', 5, 2500.00, 18.00, 12500.00, 2),
       (4, 8, 'Filing cabinets', 4, 8000.00, 18.00, 32000.00, 2),
       (5, 11, 'Teak chairs', 5, 5000.00, 18.00, 25000.00, 2)`
        );
